...
net = FeedForwardSNN(
    ...
    weights=[[np.random.normal(1.0, 0.01, num_inputs) for i in range(num_hidden)],
             [np.random.normal(1.0, 0.01, num_hidden) for i in range(num_classes)]]
).build()
...
with open('train_eval_acc_exact.npy', 'wb') as f:
